...
import { User, DollarSign, Loader2, Eye, Edit, BookOpen, Phone } from "lucide-react";
...
export const ViewEditStudentModal = ({
    ...
    const availableSubjects = group === "Pre-Medical" ? premedSubjects :
        group === "Pre-Engineering" ? preengSubjects : [];
    ...
    useEffect(() => {
        if (student && open) {
            ...
            setAdmissionDate(student.admissionDate ? student.admissionDate.split('T')[0] : "");
    ...
    const DataRow = ({ label, value, isPlaceholderValue = false }: { label: string; value: string; isPlaceholderValue?: boolean }) => (
        <div className="flex justify-between items-center py-2.5 border-b border-slate-100 dark:border-slate-800">
            <span className="text-sm text-muted-foreground">{label}</span>
            <span className={`font-medium ${isPlaceholderValue ? 'italic text-slate-400 text-sm' : 'text-foreground'}`}>
                {value || "—"}
            </span>
        </div>
    );
                        ...
                        <>
                            ...
                            <div>
                                <div className="flex items-center gap-2 mb-3">
                                    ...
                                    <span className="text-sm font-semibold text-foreground uppercase tracking-wide">Personal Information</span>
                                </div>
                                <div className="bg-white dark:bg-slate-900/50 rounded-xl border border-slate-100 dark:border-slate-800 px-4">
                                    ...
                                    <DataRow label="Father's Name" value={fatherName} isPlaceholderValue={isPlaceholder(fatherName)} />
                                    ...
                                    <div className="flex justify-between items-center py-2.5">
                                        ...
                                        <span className="font-medium text-foreground">{formatDate(admissionDate)}</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <div className="bg-white dark:bg-slate-900/50 rounded-xl border border-slate-100 dark:border-slate-800 px-4">
                                    ...
                                    <DataRow label="Student Cell No." value={studentCell || "Not provided"} />
                                    <div className="flex justify-between items-center py-2.5">
                            ...
                            <div>
                                <div className="flex items-center gap-2 mb-3">
                                    ...
                                    <span className="text-sm font-semibold text-foreground uppercase tracking-wide">Financial Summary</span>
                                </div>
                                <div className="grid grid-cols-3 gap-3">
                                    ...
                                    <div className="bg-white dark:bg-slate-900/50 rounded-xl border border-slate-100 dark:border-slate-800 p-4 text-center">
                                        <p className="text-xs text-muted-foreground uppercase tracking-wide mb-1">Monthly Fee</p>
                                    ...
                                    {/* Paid Amount */}
                                    <div className="bg-white dark:bg-slate-900/50 rounded-xl border border-slate-100 dark:border-slate-800 p-4 text-center">
                                        <p className="text-xs text-muted-foreground uppercase tracking-wide mb-1">Paid Amount</p>
                                    ...
                                    <div className={`rounded-xl border p-4 text-center ${balance > 0
                        ...
                        <>
                            ...
                            <div className="space-y-4 bg-sky-50/50 dark:bg-sky-950/20 p-4 rounded-xl border border-sky-200 dark:border-sky-800">
                                <div className="flex items-center gap-2">
                                    <DollarSign className="h-4 w-4 text-sky-600" />
                                    <Label className="text-base font-medium">Financial Details</Label>
                                </div>

                                <div className="grid grid-cols-3 gap-4">
                                    <div className="space-y-2">
                                        <Label htmlFor="totalFee" className="text-sm text-muted-foreground">
                                            Monthly Fee (PKR)
                                        </Label>
                                        <Input
                                            id="totalFee"
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <div className={`h-10 flex items-center justify-center rounded-md border font-bold text-lg ${balance > 0
                ...
                <DialogFooter className="px-6 py-4 border-t border-slate-100 dark:border-slate-800 bg-slate-50/50 dark:bg-slate-900/50">
                    {mode === "view" ? (
                        ...
                        <>
                            <Button
                                variant="outline"
                                onClick={() => mode === "edit" && student ? setMode("view") : onOpenChange(false)}
