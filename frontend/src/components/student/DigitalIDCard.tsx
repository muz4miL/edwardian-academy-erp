...
import { Shield, User, GraduationCap, Calendar, Printer } from "lucide-react";
...
export const DigitalIDCard = ({ student }: DigitalIDCardProps) => {
    ...
    const handlePrintBarcode = useReactToPrint({
        ...
        documentTitle: `Barcode_${student.barcodeId || student.studentId}`,
    });
        ...
        <div className="space-y-6">
            ...
            <Card className="max-w-sm mx-auto">
                <CardContent className="p-6 text-center space-y-4">
                    ...
                    >
                        ...
                        Print ID Barcode Sticker
                    </Button>
                </CardContent>
            </Card>

            {/* Hidden Print Template for Barcode Only */}
            <div style={{ display: "none" }}>
                <div ref={barcodeRef} style={{ padding: "20px", textAlign: "center" }}>
                    <style>{`
            @media print {
              @page {
                size: 2.5in 1.5in;
          ...
          `}</style>
                    <div style={{ marginBottom: "10px" }}>
                        <p style={{ fontSize: "10px", fontWeight: "bold", margin: "0 0 5px 0" }}>
                            THE EDWARDIAN'S ACADEMY
                        </p>
                        <p style={{ fontSize: "8px", margin: "0" }}>Student ID Barcode</p>
                    </div>
                    <Barcode
                        value={displayId}
                        width={1.5}
