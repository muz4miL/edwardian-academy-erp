...
export function ImageCapture({
    ...
    if (mode === "webcam") {
        return (
            <div className={cn("flex flex-col items-center gap-3", className)}>
                <div className="relative rounded-xl overflow-hidden border-2 border-amber-500/30 shadow-lg">
                    <Webcam
                        ref={webcamRef}
                        audio={false}
    ...
    return (
        <div className={cn("flex flex-col items-center gap-3", className)}>
            ...
            >
                {isProcessing ? (
                    <RefreshCw className={cn("text-gray-400 animate-spin", config.icon)} />
                ) : (
            ...
            <div className="flex gap-2">
                <Button
                    ...
                    className={cn("border-amber-500/50 text-amber-600 hover:bg-amber-50 dark:hover:bg-amber-950", config.button)}
                >
                    <Camera className="h-4 w-4 mr-1" />
                    Webcam
                </Button>
