...
// Auto-detects environment at RUNTIME (not build-time)
// This ensures the correct API URL is used regardless of when/where the build was created
...
export { API_BASE_URL as API_BASE_URL_LIB } from '../lib/api';
